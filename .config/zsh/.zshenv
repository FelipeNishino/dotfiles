...
# Java - GTKLookAndFeel for DBeaver
export _JAVA_OPTIONS="-Djava.util.prefs.userRoot=$XDG_CONFIG_HOME/java -Dswing.defaultlaf=com.sun.java.swing.plaf.gtk.GTKLookAndFeel"
